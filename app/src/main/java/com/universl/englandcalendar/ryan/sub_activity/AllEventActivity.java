...
public class AllEventActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    TextView all_event,england,north_ireland,wales,scotland;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='#ffffff'>Events</font>"));
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_home);

        all_event = findViewById(R.id.public_event);
        england = findViewById(R.id.england_event);
        wales = findViewById(R.id.wales_event);
        scotland = findViewById(R.id.scotland_event);
        north_ireland = findViewById(R.id.north_ireland_event);

        all_event.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AllEventActivity.this,EventsActivity.class);
                intent.putExtra("event","all_event");
        ...
        scotland.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AllEventActivity.this,EventsActivity.class);
                intent.putExtra("event","scotland");
                startActivity(intent);
                finish();
            }
        });
        north_ireland.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AllEventActivity.this,EventsActivity.class);
                intent.putExtra("event","north_ireland");
                startActivity(intent);
                finish();
            }
        });
